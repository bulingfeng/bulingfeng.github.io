...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/1-常见的时间复杂度.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/2-时间复杂度趋势变化图.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/3-单向链表.png)

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/4-单链表插入和删除.png)

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/5-循环链表.png)

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/6-双向链表.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/7-单链表插入.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/8-插入排序.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/9-二分查找法变种.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/10-树结构.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/11-深度-层数-高度.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/12-二叉树.png)

判断哪些是完全二叉树

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/13-哪些是完全二叉树.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/14-树的链式存储法.png)

顺序存储法

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/15-顺序存储法.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/16-前中后序遍历.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/17-二叉查找树.png)

#### 查找

> 先取root节点数据，然后根据左边小于root节点，右边大于root节点来进行循环遍历；

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/18-二叉查找树-查找.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/19-二叉查找树-删除.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/20-平衡二叉树-非平衡二叉树.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/21-红黑树.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/22-斐波那契数列树.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/23-堆的示意图.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/24-使用数组存储堆.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/25-堆化-1.png)

> 先把元素放到堆的最后面，也就是数组的最后一个位置。
>
> 如果插入的节点的值是大于父节点的，那就就一直往上进行变量和交换，直到交换的父节点的是大于等于下面的左右两个节点的。

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/26-堆化-2.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/27-删除堆顶-1.png)

> 换个思路，如果是拿数组最后的一个元素放到堆顶，那么剩下的只需要从堆顶开始向下进行堆化即可。

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/28-删除堆顶-2.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/29-堆排序-1.png)

![](https://bulingfeng.com/img/geektime/image/algorithm-structure/30-堆排序-2.png)
...
![](https://bulingfeng.com/img/geektime/image/algorithm-structure/31-堆排序-3.png)
